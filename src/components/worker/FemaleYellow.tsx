...
Command: npx gltfjsx@6.2.18 .\FemaleYellow.gltf 
*/
...
export function FemaleYellow(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/worker/FemaleYellow.gltf')
...
useGLTF.preload('/worker/FemaleYellow.gltf')
