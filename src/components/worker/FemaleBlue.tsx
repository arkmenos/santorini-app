...
Command: npx gltfjsx@6.2.18 .\FemaleBlue.gltf 
*/
...
export function FemaleBlue(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/worker/FemaleBlue.gltf')
...
useGLTF.preload('/worker/FemaleBlue.gltf')
