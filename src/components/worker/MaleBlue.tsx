...
Command: npx gltfjsx@6.2.18 .\MaleBlue.gltf 
*/
...
export function MaleBlue(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/worker/MaleBlue.gltf')
...
useGLTF.preload('/worker/MaleBlue.gltf')
