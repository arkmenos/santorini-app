...
Command: npx gltfjsx@6.2.18 .\MaleWhite.gltf 
*/
...
export function MaleWhite(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/worker/MaleWhite.gltf')
...
useGLTF.preload('/worker/MaleWhite.gltf')
